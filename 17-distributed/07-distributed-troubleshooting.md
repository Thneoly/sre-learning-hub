...
- 能说出分布式机制故障在全站 208 条场景索引里的分布位置，并从"现象"快速跳回本章
...
## 4. 与 SCENARIOS.md 的衔接：208 条场景里的分布式故障

[SCENARIOS.md](../SCENARIOS.md) 是全站"现象进门"索引（208 条）。分布式机制类故障集中在三个类目：
...
| §2/§3/§5/§6/§7/§8 | 105 | 间接相关若干（如 webhook fail-closed 属写路径②跳、证书过期是时间敏感故障） | 写路径①②跳 |
