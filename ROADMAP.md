...
阶段 7  方法论+理论 周 23-26  13-sre-methodology + 17-distributed（分布式理论是方法论的技术底座，大厂终面深水区）
阶段 8  云         周 27      14-cloud
阶段 9  差异化     周 28      15-aiops-llm（+补 02/05 的 Go 选学）
```
...
**进阶 capstone（选学，第二遍或求职冲刺期做）**：`06-cicd/09-11` 三章（Harbor/SonarQube/交付平台）+ labs 04-09——把闭环 3 升级为带质量门禁、镜像签名与漏洞闸门、多环境晋升、飞书通知和面板聚合的**企业级交付平台**。
