...
> 模块：日志（12-logging）｜ 建议时长：3.5 小时 ｜ 前置：01~02 章、10-pca/03 PromQL（强烈推荐）｜ 关联认证：—（无直接考点，PCA 可观测生态的日志主干）
...
学过 10-pca/03 的 PromQL（见 [10-pca/03-promql-guide.md](../10-pca/03-promql-guide.md)），LogQL 几乎是"换了选择器皮肤的 PromQL"：
